...
export default function Api05() {
  return (
    <article><a href="https://alimora83.github.io/Dice-Game/" target="_blank" rel='noreferrer'>
        <motion.img
          ...
          src="/dice.png" alt="image" /></a>
          <div className='px-0 md:px-10 pt-5 text-center'>
              <h5 className='text-gray-200'>Dice Game</h5>
              ...
              <p className='mt-1'>
                Roll the dice to get random dice roll generated</p>
